...
void exposeDifferentialActionFreeFwdDynamicsExtForces() {
  bp::class_<DifferentialActionModelFreeFwdDynamicsExtForces, bp::bases<DifferentialActionModelAbstract> >(
      ...
      bp::init<boost::shared_ptr<StateMultibody>, boost::shared_ptr<ActuationModelAbstract>, #TO finish
               boost::shared_ptr<CostModelSum> >(bp::args("self", "state", "actuation", "costs", "extforces"),
